...
error_log_data_name = "error_files_log/zerodha_data_{0}.log".format(
...
access_token = "idIc4RrKmdPfTAbYuZImqwYnAUBppeKi"
# request_token = "5YLqqh9uKsV0HxkzWHQ911qhE2pYX6aL"
            ...
            if math.isnan(val["nse_instrument_token"]) != True:
                ...
                for i in response:
                    try:
                        ...
                        print(
                            "Error in NSE Update  data for FR Token: {0}".format(
                                jas_token
                            )
                        )
                        print(e)
...
# Mapping DF instance
query_mapping = "SELECT * FROM mapping_data_jas"
...
# historical_date_to_date("", "", df_mapping)
